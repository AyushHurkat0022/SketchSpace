...
const Login: React.FC = () => {
  ...
  const [loadingMessage, setLoadingMessage] = useState("Connecting to our servers...");
      ...
      <div className="form bg-gray-100 p-6 rounded-lg border border-yellow-600 lg:p-10 max-w-3xl w-full bg-opacity-70 backdrop-blur-md">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-6">
            ...
            {/* Loading text: dark gray */}
            <p className="mt-4 text-gray-800 font-semibold">{loadingMessage}</p>
          </div>
        ) : (
        ...
        {message && <p className="mt-4 text-gray-800"><strong>!! {message} !!</strong></p>}
      </div>
    </div>
  );
};
